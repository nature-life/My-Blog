...
class RegisterForm(Form):
    ...
    superword = PasswordField('超级密码', validators=[DataRequired(), Length(1, 32)])
    blog_title = StringField('博客名', validators=[DataRequired()])   # 博客标题
    blog_sub_title = StringField('子博客名', validators=[DataRequired()]) # 子标题
