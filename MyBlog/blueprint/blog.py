...
def show_post(post_id):
    ...
    admin = Admin.query.get(post.admin_id)
    ...
    for i in comments:
        comment_user = Admin.query.get(i.admin_id)
        if comment_user:
            i.name = comment_user.name
            i.is_admin = comment_user.is_admin
            i.is_superadmin = comment_user.is_superadmin
    ...
    return render_template('blog/post.html', name=admin.name, post=post, pagination=pagination, comments=comments, form=form)
